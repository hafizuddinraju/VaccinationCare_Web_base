    ...
    <div>
        <form action="registrationinsert.php" method="post">
            <div class="container">
                ...
                <input type="text" name="child_FullName" placeholder="Enter Child Full Name" required><br>

                <label for="Guardian_Name"><b>Guardian Name </b></label>
                <input type="text" name="Guardian_Name" placeholder="Enter Guardian Name" required><br><br>

                <label for="child_birthday"><b>Child Birthday</b></label>
                <input type="date" name="child_birthday" ><br><br>
                ...
                <input type="email" name="Guardian_Email" placeholder="Enter Guardian Email" required><br>

                <label for="child_Password"><b>Password </b></label>
                <input type="password" name="child_Password" placeholder="Enter Password" required><br>

                <label for="child_Address"><b>Address </b></label>
                <input type="text" name="child_Address" placeholder="Enter Child Address" required><br>

                <label for="Guardian_Phone"><b>Phone </b></label>
                <input type="tel" id="phone" name="Guardian_Phone" value="+880" required><br><br>

                <label for="child_city"><b>Child City</b></label>
                <input type="text" name="child_city" placeholder="Enter Child City" required><br>
